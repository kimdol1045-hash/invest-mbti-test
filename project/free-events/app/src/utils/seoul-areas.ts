...
const SEOUL_AREAS: { name: string; lat: number; lng: number }[] = [
  ...
  { name: '북악', lat: 37.5925, lng: 126.9818 },

  // 주요 랜드마크
  { name: '코엑스', lat: 37.5120, lng: 127.0590 },
  { name: '예술의전당', lat: 37.4784, lng: 127.0115 },
  { name: '세종문화회관', lat: 37.5723, lng: 126.9760 },
  { name: 'DDP', lat: 37.5668, lng: 127.0098 },
  { name: '동대문디자인플라자', lat: 37.5668, lng: 127.0098 },
  { name: '국립중앙박물관', lat: 37.5239, lng: 126.9806 },
  { name: '국립현대미술관', lat: 37.5788, lng: 126.9810 },
  { name: '롯데월드타워', lat: 37.5125, lng: 127.1025 },
  { name: '경복궁', lat: 37.5796, lng: 126.9770 },
  { name: '덕수궁', lat: 37.5659, lng: 126.9751 },
  { name: '창덕궁', lat: 37.5794, lng: 126.9910 },
  { name: '남대문', lat: 37.5599, lng: 126.9756 },
